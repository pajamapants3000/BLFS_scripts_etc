...
# Installation script for kwindowsystem-5.12.0-lxqt
#
# Dependencies
#**************
# Begin Required
...
PROCEED="yes"
REINSTALL=0
grep "kwindowsystem-" /list-$CHRISTENED"-"$SURNAME > /dev/null && ((\!$?)) &&\
...
echo "kwindowsystem-5.12.0-lxqt" >> /list-$CHRISTENED"-"$SURNAME
#
###################################################
