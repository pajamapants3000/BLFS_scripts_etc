...
# Installation script for links-2.11
DATE=$(date +%Y%m%d)
TIME=$(date +%H%M%S)
#
...
VERSION=2.11
ARCHIVE=tar.bz2
MD5=d122879f2870dfec2fec1a07517c1458
#
WORKING_DIR=$PWD
SRCDIR=${WORKING_DIR}/${PROG}-${VERSION}
#
# Downloads; obtain and verify package(s)
DL_URL=http://links.twibright.com/download
DL_ALT=
# Prepare sources
...
as_root install -v -m644 doc/links_cal/* KEYS BRAILLE_HOWTO \
