...
TIME=$(date +%H%M%S)
#
# For now just put requirements here, no idea what to do with them...
# Required
#gc-7.4.2
#libffi-3.2.1
#libunistring-0.9.6
...
VERSION=2.0.11
ARCHIVE=tar.xz
MD5=03f1bce1a4983076d955003472306a13
#
WORKING_DIR=$PWD
...
CONFIG_FLAGS="--disable-static --docdir=/usr/share/doc/${PROG}-${VERSION}"
MAKE="make"
MAKE_FLAGS=""
#TEST="check"
TEST_FLAGS="-k"
...
as_root ${MAKE} ${INSTALL_FLAGS} ${INSTALL}-html
as_root mv /usr/lib/libguile-*-gdb.scm /usr/share/gdb/auto-load/usr/lib
as_root mv /usr/share/doc/guile-2.0.11/{guile.html,ref}
as_root mv /usr/share/doc/guile-2.0.11/r5rs{.html,}
find examples -name "Makefile*" -delete
as_root cp -vR examples   /usr/share/doc/guile-2.0.11
for DIRNAME in r5rs ref; do
      as_root install -v -m644  doc/${DIRNAME}/*.txt \
