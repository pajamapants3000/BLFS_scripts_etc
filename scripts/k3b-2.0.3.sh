...
#libsamplerate-0.1.8
# Recommended
#cdrtools (required to burn cdrom)
#dvd+rw-tools-7.1 (required to burn dvd)
#Cdrdao-1.2.3 (required to burn in DAO mode (Disk-At-Once)
#libkcompactdisc
#audiocd_kio
#ffmpeg-2.8.3
#libdvdread-5.0.3
...
if [[ -z ${KDE_PREFIX} ]]; then
    echo "KDE must be installed, and KDE_PREFIX defined correctly"
    exit 1
fi
...
DL_ALT=
MD5=52e78aabe8e483347d04e88be0aed150
SHASUM=
SHAALG=1
REPO=
...
CONFIG_FLAGS="-DSYSCONF_INSTALL_DIR=${SYSCONFDER}"
MAKE="make"
MAKE_FLAGS=""
TEST=
TEST_FLAGS="-k"
