...
# Options
#********
# Build API docs if doxygen is present
API_DOCS=1
...
DL_URL=https://github.com/htacg/tidy-html5/archive
DL_ALT=
...
CONFIG_FLAGS="-DBUILD_TAB2SPACE=ON"
MAKE_FLAGS=""
TEST=
TEST_FLAGS="-k"
INSTALL="install"
...
#
${INSTALL_BINROOT} tab2space ${PREFICKS}/bin
if ((API_DOCS)) &&
    (cat /list-${CHRISTENED}-${SURNAME} | grep "^doxygen" > /dev/null); then
    pushd ${SRCDIR}/documentation
    doxygen doxygen.cfg
    as_root cp -R temp/tidylib_api ${DOCDER}
    popd
fi
