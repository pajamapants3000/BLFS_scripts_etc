...
#
#
#   NO MTA: Use Tripwire-2.4.2.2-SMTP
#
#
...
make
#
# Modify for lack of MTA if not installed
...
as_root cp -v policy/*.txt /usr/share/doc/tripwire
#
cd ..
as_root rm -rf tripwire-2.4.2.2-src
#
# Add to installed list for this computer:
echo "tripwire-2.4.2.2" >> /list-$CHRISTENED"-"$SURNAME
#
...
# /etc/tripwire/*
#
# CONFIGURATION: See config file for info.
#
pathappend /usr/sbin
