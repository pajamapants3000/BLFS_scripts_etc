...
# Installation script for cups-2.0.4
#
# Dependencies
#**************
# Begin Required
...
PROCEED="yes"
REINSTALL=0
grep cups-2.0.4 /list-$CHRISTENED"-"$SURNAME > /dev/null && ((\!$?)) &&\
    REINSTALL=1 && echo "Previous installation detected, proceed?" && read PROCEED
[ $PROCEED = "yes" ] || [ $PROCEED = "y" ] || exit 0
# Download:
wget http://www.cups.org/software/2.0.4/cups-2.0.4-source.tar.bz2
# md5sum:
echo "f5c847d9a4fac6c4c66fb0526a7afaae cups-2.0.4-source.tar.bz2" | md5sum -c ;\
    ( exit ${PIPESTATUS[0]} )
#
tar -xvf cups-2.0.4-source.tar.bz2
cd cups-2.0.4
...
# Replace firefox below if desired, with browser of choice
...
./configure --libdir=/usr/lib            \
            ...
            --with-docdir=/usr/share/cups/doc-2.0.4
make
...
as_root ln -svnf ../cups/doc-2.0.4 /usr/share/doc/cups-2.0.4
as_root echo "ServerName /var/run/cups/cups.sock" > /etc/cups/client.conf
...
cd ..
as_root rm -rf cups-2.0.4
#
# Add to installed list for this computer:
echo "cups-2.0.4" >> /list-$CHRISTENED"-"$SURNAME
#
###################################################
#
# Init Script
...
#***************
#
as_root tee /etc/pam.d/cups << "EOF"
