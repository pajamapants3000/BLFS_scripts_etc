...
# Installation script for polkit_qt_1-0.112.0-qt4
#
# Dependencies
#**************
# Begin Required
...
PROCEED="yes"
REINSTALL=0
grep polkit_qt_1-0.112.0-qt4 /list-$CHRISTENED"-"$SURNAME > /dev/null && ((\!$?)) &&\
...
echo "polkit_qt_1-0.112.0-qt4" >> /list-$CHRISTENED"-"$SURNAME
#
###################################################
