...
DL_URL=http://mirror.sdunix.com/gnu/rcs
DL_ALT=http://mirrors.kernel.org/gnu/rcs
MD5=ab57933fb214384e69664ec1c81775fc
SHASUM=
SHAALG=1
REPO=
...
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#
chmod u+w ${SRCDIR}/src/base.h
sed -i 's/^\(#define exiting\)  _Noreturn/\1/' ${SRCDIR}/src/base.h
