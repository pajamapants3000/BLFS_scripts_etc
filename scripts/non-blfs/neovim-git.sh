...
# Putting in /usr/local as this is an alpha version
PREFICKS=/usr/local
SYSCONFDER=/etc
LOCALST8DER=/var
...
#CMAKE_PARALLEL=1
CFLAGS="-U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=1 -Wno-error -O2 -march=native"
CONFIG_FLAGS=""
MAKE="make"
MAKE_FLAGS="CMAKE_INSTALL_PREFIX=/usr/local CMAKE_BUILD_TYPE=RelWithDebInfo"
TEST=
TEST_FLAGS="-k"
INSTALL="install"
INSTALL_FLAGS=""
