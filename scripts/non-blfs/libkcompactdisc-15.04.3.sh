...
MD5=7db8bcf4e0386bf38102de6424c4a410
SHASUM=db281e6285a480f164175838158e01344041ce58
SHAALG=1
REPO=
...
#
    ...
    if ! [ -f ${PROG}-${VERSION}.${ARCHIVE} ]; then
        wget ${DL_URL}/${VERSION}/src/${PROG}-${VERSION}.${ARCHIVE} \
            -O ${WORKING_DIR}/${PROG}-${VERSION}.${ARCHIVE} || FAIL_DL=1
        # FTP/alt Download:
        if (($FAIL_DL)) && [ "$DL_ALT" ]; then
            wget ${DL_ALT}/${VERSION}/src/${PROG}-${VERSION}.${ARCHIVE} \
