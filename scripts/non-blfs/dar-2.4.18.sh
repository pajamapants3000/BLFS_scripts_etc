...
#
# Dependencies - include configure options to change from default:
#Optional
#libz for gzip compression support. --disable-libz-linking
#libbzip2 for bzip2 compression support. --disable-libbz2-linking
#liblzo2 for lzo compression support. --disable-liblzo2-linking
#GNU Getopt support - comes with glibc. 
#--disable-gnugetopt-linking
#libgcrypt >= 1.4.0 for symmetric strong encryption and hash support.
#--disable-libgcrypt-linking
#doxygen - generate source documentation
#upx - generate compressed binaries of this program
#--disable-upx
#groff - generate html versions of manpages. --disable-build-html
#
# Options
#
#--enable-examples
#--enable-debug
#--disable-dar-static
#--enable-os-bits=[32,64] overrides detected value
#--enable-mode=[32,64] integer bits instead of default infinint
#--disable-rpath do not hardcode runtime library paths
#--enable-static[=PKGS] (default=yes)
#--enable-shared[=PKGS] (default=yes)
...
VERSION=2.4.18
ARCHIVE=tar.gz
MD5=fc243d3e4702bcbb78e553b4a659d4eb
#
WORKING_DIR=$PWD
...
if ! [ -f ${PROG}-${VERSION}.${ARCHIVE} ]; then
    wget \
    ${DL_URL}/${PROG}/files/${PROG}/${VERSION}/${PROG}-${VERSION}.${ARCHIVE} \
