...
#
# NOTE: The purpose of this installation is to have the libraries necessary
#+to build programs that aren't compatible with newer versions of lua. In
#+particular, tolua++ and conky.
#
# Dependencies
#
# Options
