...
VERSION=7.3
ARCHIVE=tar.gz
MD5=d62647d897f9196ade034363e0d58c13
#
WORKING_DIR=$PWD
...
# I ran this with qt5, even though the instructions say to use qt4; I think
...
#
# Linker missing this and I don't feel like figuring it out...
if ((${KDE})); then
    sed -i 's/-lpthread/-lX11 -lpthread/' src/CMakeFiles/kchmviewer.dir/link.txt
fi
${MAKE} ${MAKE_FLAGS}
#
# Test:
...
if ((${KDE})); then
    ...
    as_root install -v -Dm755 -o root -g root bin/kchmviewer /usr/bin/
    as_root install -v -Dm755 -o root -g root packages/kchmviewer.desktop \
        /usr/share/applications/
    as_root install -v -Dm755 -o root -g root packages/kchmviewer.png \
        /usr/share/icons/
fi
popd
