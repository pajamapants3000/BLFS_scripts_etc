...
DL_ALT=
MD5=612bb8127d0d31da6e5474edf8a5c247
SHASUM=49ecfe2a0939232ca78ce318d938044e7f751b6d
SHAALG=1
REPO=
...
CONFIG_FLAGS="--enable-xft --enable-png --enable-jpeg --with-x"
MAKE="make"
MAKE_FLAGS=""
TEST=
TEST_FLAGS="-k"
...
#
    ...
    if ! [ -f ${PROG}-${VERSION}.${ARCHIVE} ]; then
        wget ${DL_URL}/${PROG}/files/${PROG_ALT}%20${VERSION}%20Source%20Code/${PROG}-${VERSION}-src.${ARCHIVE} \
