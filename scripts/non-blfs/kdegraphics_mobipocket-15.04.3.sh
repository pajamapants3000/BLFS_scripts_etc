...
PROG=kdegraphics-mobipocket
VERSION=15.04.3
ARCHIVE=tar.xz
MD5=5f7f695b9625ceb17210e16b841fea9b
SHA1=
#
WORKING_DIR=$PWD
...
DL_URL=http://mirrors.mit.edu/kde/stable/applications
DL_ALT=http://kde.mirrors.hoobly.com/stable/applications
REPO=
# VCS=[git,hg,svn,...]
#VCS=${VERSION}
BRANCH=master
