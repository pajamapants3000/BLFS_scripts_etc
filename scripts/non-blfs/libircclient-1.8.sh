...
VERSION=1.8
ARCHIVE=tar.gz
MD5=a1b4fd5491a36b8aedf65a6845755800
#
WORKING_DIR=$PWD
...
# These options should be generally ok; won't install shared by default!
CONFIG_FLAGS="--enable-ipv6 --enable-openssl --enable-shared"
MAKE="make"
MAKE_FLAGS=""
TEST=
TEST_FLAGS="-k"
