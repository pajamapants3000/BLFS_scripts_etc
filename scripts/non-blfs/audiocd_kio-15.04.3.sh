...
# Dependencies
#*************
# Required (? - checked for by cmake)
#cmake-3.3.0
#libkcddb-15.04.3
#libkcompactdisc-15.04.3
#cdparanoia_III-10.2
#kdelibs-4.14.10
# Options
#********
...
DL_URL=http://kde.mirrors.hoobly.com/stable/applications
DL_ALT=http://kde.mirrors.tds.net/pub/kde/stable/applications
MD5=d7151a6438920ec0e1de10e035701b36
SHASUM=c575f4b824762f6114fff4113ceeba99816d6952
SHAALG=1
REPO=
...
[ ${KDE_PREFIX} ] && PREFICKS=${KDE_PREFIX} || PREFICKS=/usr
SYSCONFDER=/etc
LOCALST8DER=/var
...
#
    ...
    if ! [ -f ${PROG}-${VERSION}.${ARCHIVE} ]; then
        wget ${DL_URL}/${VERSION}/src/${PROG_ALT}-${VERSION}.${ARCHIVE} \
            -O ${WORKING_DIR}/${PROG}-${VERSION}.${ARCHIVE} || FAIL_DL=1
        # FTP/alt Download:
        if (($FAIL_DL)) && [ "$DL_ALT" ]; then
            wget ${DL_ALT}/${VERSION}/src/${PROG_ALT}-${VERSION}.${ARCHIVE} \
