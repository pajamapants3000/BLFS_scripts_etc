...
VERSION=1.4.0
ARCHIVE=tar.xz
MD5=92da1a7a1249612b54623500ea41167c
#
WORKING_DIR=$PWD
...
DL_ALT=http://mirror.cc.columbia.edu/pub/software/kde/stable
# Prepare sources
...
sed -i 's/find_package(Msgfmt REQUIRED)/#&/' CMakeLists.txt
sed -i 's/add_subdirectory( doc-translations )/add_subdirectory( plasma )/' \
    CMakeLists.txt
#
##cmake child build
