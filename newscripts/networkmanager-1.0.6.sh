...
VERSION=1.0.6
ARCHIVE=tar.xz
MD5=00f5f9ec69725a9f9b99366853c6f73e
#
WORKING_DIR=$PWD
SRCDIR=${WORKING_DIR}/${PROG}-${VERSION}
#
# Downloads; obtain and verify package(s)
DL_URL=http://ftp.gnome.org/pub/gnome/sources/NetworkManager/1.0
DL_ALT=ftp://ftp.gnome.org/pub/gnome/sources/NetworkManager/1.0
# Prepare sources
...
#CONFIG_FLAGS
#
CONFIG_FLAGS="${CONFIG_FLAGS} --with-nmtui --disable-ppp"
CONFIG_FLAGS="${CONFIG_FLAGS} --with-systemdsystemunitdir=no"
CONFIG_FLAGS="${CONFIG_FLAGS} --docdir=/usr/share/doc/network-manager-1.0.6"
MAKE="make"
